...
type
  TMainFrm = class(TForm)
    ...
    procedure Silver2Click(Sender: TObject);
...
uses AdvStyleIF, U_DM, U_AppLog, UserMenu,
  ...
  U_Data_Log, U_LapPendParkir, U_Helm, U_LapSetoran;
...
procedure TMainFrm.Silver2Click(Sender: TObject);
begin
  if not isWindowsFound('TLapSetoranFrm') then begin
    U_LapSetoran.ShowForm('Seccret Rep', 10232);
