object LapSetoranFrm: TLapSetoranFrm
      ...
      object grdRekap: TcxGrid
        ...
        object grdDBTV_Rekap: TcxGridDBTableView
          ...
          object grdDBTV_Rekapjml_kendaraan: TcxGridDBColumn
            ...
            DataBinding.FieldName = 'jumlah_kendaraan'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 142
          ...
          object grdDBTV_Detail: TcxGridDBTableView
            ...
            DataController.Summary.FooterSummaryItems = <
              ...
              item
                Format = ',0'
                Kind = skSum
                Column = grdDBTV_Detailjam_masuk
              end
              item
                Kind = skCount
                Column = grdDBTV_DetailColumn4
              end>
            DataController.Summary.SummaryGroups = <>
            OptionsCustomize.ColumnsQuickCustomization = True
            OptionsData.CancelOnExit = False
  ...
  object qRekap: TZQuery
    Connection = DM.conn
    BeforeOpen = qRekapBeforeOpen
    SQL.Strings = (
      'select a.usr_ins, b.tarif,'
      '(select count(a.usr_ins)) as jumlah_kendaraan,'
      '(select sum(b.tarif)) as total_pendapatan'
      'from trans.karcis_hilang a'
      'left join master.mtarif b on b.id_jns_anggota=a.no_hp '
      
        'where a.dt_ins between to_timestamp(:ptgl0,'#39'dd-mm-yyyy'#39') and to_' +
        'timestamp(:ptgl1,'#39'dd-mm-yyyy'#39') + interval '#39'23 hour  59 minute 59' +
        ' second'#39
      'group by a.usr_ins, b.tarif')
    Params = <
      item
        DataType = ftString
        Name = 'ptgl0'
    ...
    object qRekaptarif: TFloatField
      FieldName = 'tarif'
    end
    object qRekapjumlah_kendaraan: TLargeintField
      Alignment = taCenter
      FieldName = 'jumlah_kendaraan'
      ReadOnly = True
    end
    object qRekaptotal_pendapatan: TFloatField
      FieldName = 'total_pendapatan'
      ReadOnly = True
      DisplayFormat = ',0'
    end
  ...
  object Detail: TZQuery
    ...
    SQL.Strings = (
        ...
        'select a.nopol, a.type_kendaraan, a.no_ktp as no_karcis, a.alama' +
        't as capture_filename, a.no_hp as jns_pelanggan, a.usr_ins, a.na' +
        'ma as shift, a.dt_ins,'
      'b.tarif'
      'from trans.karcis_hilang a'
      'left join master.mtarif b on b.id_jns_anggota=a.no_hp '
    ...
    object Detailcapture_filename: TStringField
      FieldName = 'capture_filename'
      Size = 1020
    end
    object Detailjns_pelanggan: TStringField
      Alignment = taCenter
      FieldName = 'jns_pelanggan'
      Size = 1020
    end
