object LapKasirPerShiftFrm: TLapKasirPerShiftFrm
    ...
    object tabRekap: TcxTabSheet
      ...
      object grdRekap: TcxGrid
        ...
        object grdDBTV_Rekap: TcxGridDBBandedTableView
          ...
          object grdDBTV_Rekapid_jns_anggota: TcxGridDBBandedColumn
            Caption = 'Status'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBPrintjns_kendaraan: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBPrint."id_jns_kendaraan"] - [frxDBPrint."status"]')
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object Detail: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'select * from  public.fn_get_detail_shift(:ptgl,:pshift)')
    Params = <
      item
        DataType = ftUnknown
        Name = 'ptgl'
