object ChangePasswordFrm: TChangePasswordFrm
  ...
  object lblHeaderComment: TLabel
    ...
    Width = 238
    Height = 16
    Caption = 'Ganti Password Untuk Pengguna '
    Color = clWhite
  ...
  object lblDescription: TLabel
    ...
    AutoSize = False
    Caption = 
      'Silakan masukkan password lama dan password baru untuk proses pe' +
      'rubahan :'
    Color = clWhite
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblComments: TLabel
      ...
      AutoSize = False
      Caption = 
        'Pengguna bisa mengganti password sesuai keinginan. Password yang' +
        ' biasa digunakan (tgl lahir, nama, dll) bisa meningkatkan resiko' +
        ' keamanan data.'
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
