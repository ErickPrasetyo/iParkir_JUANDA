...
class CreateTagvalElgsTranscodeLogTable extends Migration
{
    /**
     * Run the migrations.
     *
     * @return void
     */
    private $table_name = TABEL_TAGVAL_ELGS_TRANSCODE_LOG;
    ...
    public function up()
    {
        if (Schema::hasTable($this->table_name)) {
            ...
            Schema::create($this->table_name, function (Blueprint $table) {
                $table->increments('tagval_elgs_transcode_log_id');
