...
class SendController extends RouterController
{
    public function registerExp()
    {
        try {
            ...
            $terminal = TERMINAL;
            $encryptedBase64KeyDev = ENCRYPTED_KEY;
            ...
            //enkrip data
            $encryptedData = SendData::sendingAPI('localhost:5000/enc', 'POST', json_encode($payloadExp));
            ...
            $responseCurl = SendData::sendingData('register', $encryptedData);
